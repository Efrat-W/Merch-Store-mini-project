...
internal class Program
{
    ...
    private void ProductMenu()
    {
            ...
            Console.WriteLine(@"Enter one of the following:
            0: add product
            1: print product (by id)
            2: print the list of products
            3: update a certain product
            4: delete a product");
            string input = Console.ReadLine();
        ...
        void OrderItemMenu()
    {
            ...
            Console.WriteLine(@"Enter one of the following:
            0: add order item
            1: print order item (by id)
            2: print the list of order items
            3: update a certain order item
            4: delete an order item
            5: print order item (by product and order)
            6: print all the items in a certain order"); 
            string input = Console.ReadLine();
            op = (options)Enum.Parse(typeof(options), input);
